...
export default function ApiTestPage() {
  ...
  return (
    <Row gutter={[16, 16]}>
      <Col xs={24} md={16}>
        <Card title="测试 Token 注入" size="small" style={{ marginBottom: 12 }} bordered={false}>
          <Form
            form={tokenForm}
            layout="vertical"
            initialValues={{
            ...
            items={[
                ...
                children: (
                  <Space direction="vertical" size="large" style={{ width: "100%" }}>
                      ...
                      <Space>
                        <Button
                          ...
                          onClick={() => {
                            ...
                            return run("login", () =>
                              apiV1.auth.login({ emailOrUsername, password }),
                            );
                          }}
                        >
                          登录
                    ...
                    <Paragraph style={{ wordBreak: "break-all" }}>
                      当前 accessToken:{" "}
                      {tokenVersion >= 0 ? tokenManager.getAccessToken() || "(空)" : ""}
                    </Paragraph>
                    <Paragraph style={{ wordBreak: "break-all" }}>
                      当前 refreshToken:{" "}
                      {tokenVersion >= 0 ? tokenManager.getRefreshToken() || "(空)" : "(空)"}
                    </Paragraph>
                  </Space>
                ),
              },
                    ...
                    >
                      ...
                      <Space>
                          ...
                          onClick={async () => {
                            const res = await run("createWorkspace", () =>
                              apiV1.workspaces.createWorkspace({
                                name:
                                  workspaceForm.getFieldValue("name") ?? `测试空间_${Date.now()}`,
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("listWorkspaces", () => apiV1.workspaces.listWorkspaces())
                          }
                        >
                          列表
                        </Button>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const id = workspaceForm.getFieldValue("workspaceId");
                            return run("deleteWorkspace", () =>
                              apiV1.workspaces.deleteWorkspace(id),
                            );
                          }}
                        >
                          删除
                      ...
                      <Space wrap>
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            const title =
                              docForm.getFieldValue("title") ?? `测试文档_${Date.now()}`;
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("getDocument", () =>
                              apiV1.documents.getDocument(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          详情
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("content", () =>
                              apiV1.documents.getDocumentContent(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          内容
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("publish", () =>
                              apiV1.documents.publishDocument(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          发布
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("deleteDocument", () =>
                              apiV1.documents.deleteDocument(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          删除
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("revisions", () =>
                              apiV1.documents.getRevisions(docForm.getFieldValue("docId"), {
                                page: 1,
                                pageSize: 20,
                              }),
                            )
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("snapshot", () =>
                              apiV1.documents.createSnapshot(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          创建快照
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("pending", () =>
                              apiV1.documents.getPendingVersions(docForm.getFieldValue("docId")),
                            )
                          }
                        >
                          待创建版本数
                    ...
                    <Form form={tagForm} layout="vertical">
                      ...
                      <Space wrap>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("getTag", () => apiV1.tags.getTag(tagForm.getFieldValue("tagId")))
                          }
                        >
                          标签详情
                        </Button>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("tagUsage", () =>
                              apiV1.tags.getTagUsage(tagForm.getFieldValue("tagId")),
                            )
                          }
                        >
                          使用统计
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("deleteTag", () =>
                              apiV1.tags.deleteTag(tagForm.getFieldValue("tagId")),
                            )
                          }
                        >
                          删除标签
                    ...
                    <Form form={favoriteForm} layout="vertical">
                      ...
                      <Space>
                        <Button
                          ...
                          onClick={() =>
                            run("addFavorite", () =>
                              apiV1.favorites.addFavorite({
                                docId: favoriteForm.getFieldValue("docId"),
                              }),
                            )
                          }
                        >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("listFavorites", () => apiV1.favorites.listFavorites())
                          }
                        >
                          收藏列表
                        </Button>
                        <Button
                          ...
                          onClick={() =>
                            run("removeFavorite", () =>
                              apiV1.favorites.removeFavorite(favoriteForm.getFieldValue("docId")),
                            )
                          }
                        >
                          取消收藏
                    ...
                    <Form form={commentForm} layout="vertical">
                      ...
                      <Space wrap>
                          ...
                          onClick={() =>
                            run("createComment", () =>
                              apiV1.comments.createComment({
                                ...
                                parentCommentId:
                                  commentForm.getFieldValue("parentCommentId") || undefined,
                              }),
                            )
                          }
                        >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("getComment", () =>
                              apiV1.comments.getComment(commentForm.getFieldValue("commentId")),
                            )
                          }
                        >
                          详情
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("deleteComment", () =>
                              apiV1.comments.deleteComment(commentForm.getFieldValue("commentId")),
                            )
                          }
                        >
                          删除
              ...
              },
              {
                ...
                children: (
                  <Space direction="vertical" style={{ width: "100%" }}>
                    <Upload {...uploadProps}>
                      <Button loading={loadingKey === "uploadAsset"}>
                        上传资产（使用 workspaceId）
                      </Button>
                    </Upload>
                    <Form form={assetForm} layout="vertical">
                      ...
                      <Space wrap>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("deleteAsset", () =>
                              apiV1.assets.deleteAsset(assetForm.getFieldValue("assetId")),
                            )
                          }
                        >
                          删除资产
                    ...
                    <Form form={securityForm} layout="vertical">
                      ...
                      <Space wrap>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            run("auditLogs", () =>
                              apiV1.security.getAuditLogs({ page: 1, pageSize: 20 }),
                            )
                          }
                        >
                          审计日志
